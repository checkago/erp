...
class AdultVisitReportForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'qty_visited_neb': forms.NumberInput(attrs={'class': 'form-control'}),
            'qty_visited_prlib': forms.NumberInput(attrs={'class': 'form-control'}),
...
class ChildVisitReportForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'qty_reg_other': forms.NumberInput(attrs={'class': 'form-control'}),
            'qty_reg_prlib': forms.NumberInput(attrs={'class': 'form-control'}),
