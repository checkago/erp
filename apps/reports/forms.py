...
class BookReportForm(forms.ModelForm):
    class Meta:
        model = BookReport
        fields = ['cafedra', 'date', 'qty_books_14', 'qty_books_15_35', 'qty_books_other', 'qty_books_invalid',
...
class VisitReportForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['cafedra', 'date', 'qty_reg_7', 'qty_reg_14', 'qty_reg_15_35', 'qty_reg_other', 'qty_reg_invalid',
                  ...
                  'qty_visited_invalids', 'qty_visited_prlib', 'qty_visited_litres', 'qty_visited_out_station', 'note']
        widgets = {
