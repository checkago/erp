...
def generate_book_report_excel(user, year, month):
    ...
    ws['U'] = year_start_data['qty_books_part_other']
    ws['V5'] = year_start_data['qty_books_part_audio']
    ws['W5'] = year_start_data['qty_books_part_krai']
    ws['X5'] = year_start_data['qty_books_reference_do_14']
    ws['Y5'] = year_start_data['qty_books_reference_14']
    ws['Z5'] = year_start_data['qty_books_reference_35']
    ws['AA5'] = year_start_data['qty_books_reference_other']
    ...
    ws[f'X{row_num}'] = first_data['qty_books_reference_do_14']
    ws[f'Y{row_num}'] = first_data['qty_books_reference_14']
    ws[f'Z{row_num}'] = first_data['qty_books_reference_35']
    ws[f'AA{row_num}'] = first_data['qty_books_reference_other']
    ...
    if len(daily_data) > 1:
        for day, data in sorted(daily_data.items())[1:]:
            ...
            ws[f'X{row_num}'] = data['qty_books_reference_do_14']
            ws[f'Y{row_num}'] = data['qty_books_reference_14']
            ws[f'Z{row_num}'] = data['qty_books_reference_35']
            ws[f'AA{row_num}'] = data['qty_books_reference_other']
