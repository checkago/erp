...
def generate_book_report_excel(user, year, month):
    ...
    ws[f'L{row_num}'] = first_data['qty_books_part_opl']
    ws[f'M{row_num}'] = first_data['qty_books_part_enm']
    ws[f'N{row_num}'] = first_data['qty_books_part_tech']
    ws[f'O{row_num}'] = first_data['qty_books_part_sh']
    ws[f'P{row_num}'] = first_data['qty_books_part_si']
    ws[f'Q{row_num}'] = first_data['qty_books_part_yl']
    ws[f'R{row_num}'] = first_data['qty_books_part_hl']
    ws[f'S{row_num}'] = first_data['qty_books_part_dl']
    ws[f'T{row_num}'] = first_data['qty_books_part_other']
    ws[f'U{row_num}'] = first_data['qty_books_part_audio']
    ws[f'V{row_num}'] = first_data['qty_books_part_krai']
    ws[f'W{row_num}'] = first_data['qty_books_reference_do_14']
    ws[f'X{row_num}'] = first_data['qty_books_reference_14']
    ws[f'Y{row_num}'] = first_data['qty_books_reference_35']
    ws[f'Z{row_num}'] = first_data['qty_books_reference_other']
    ws[f'AA{row_num}'] = first_data['qty_books_reference_invalid']
    ...
    if len(daily_data) > 1:
        for day, data in sorted(daily_data.items())[1:]:
            ...
            ws[f'L{row_num}'] = data['qty_books_part_opl']
            ws[f'M{row_num}'] = data['qty_books_part_enm']
            ws[f'N{row_num}'] = data['qty_books_part_tech']
            ws[f'O{row_num}'] = data['qty_books_part_sh']
            ws[f'P{row_num}'] = data['qty_books_part_si']
            ws[f'Q{row_num}'] = data['qty_books_part_yl']
            ws[f'R{row_num}'] = data['qty_books_part_hl']
            ws[f'S{row_num}'] = data['qty_books_part_dl']
            ws[f'T{row_num}'] = data['qty_books_part_other']
            ws[f'U{row_num}'] = data['qty_books_part_audio']
            ws[f'V{row_num}'] = data['qty_books_part_krai']
            ws[f'W{row_num}'] = data['qty_books_reference_do_14']
            ws[f'X{row_num}'] = data['qty_books_reference_14']
            ws[f'Y{row_num}'] = data['qty_books_reference_35']
            ws[f'Z{row_num}'] = data['qty_books_reference_other']
            ws[f'AA{row_num}'] = data['qty_books_reference_invalid']
            ws[f'AB{row_num}'] = data['qty_books_reference_online']
            ws[f'AC{row_num}'] = data['note']
