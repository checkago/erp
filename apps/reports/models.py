...
class Event(models.Model):
    ...
    age_35 = models.IntegerField(default=0, verbose_name='От 18 до 35')
...
class VisitReport(models.Model):
    ...
    qty_reg_15_35 = models.IntegerField(default=0, verbose_name='Новые (15-17)')
    qty_reg_18_35 = models.IntegerField(default=0, verbose_name='Новые (Молодежь 18-35)')
    ...
    qty_visited_15_35 = models.IntegerField(default=0, verbose_name='Посещение (15-17)')
    qty_visited_18_35 = models.IntegerField(default=0, verbose_name='Посещение (Молодежь 18-35)')
...
class BookReport(models.Model):
    ...
    qty_books_reference_14 = models.IntegerField(default=0, verbose_name='Справки (15-17)')
    qty_books_reference_18 = models.IntegerField(default=0, verbose_name='Справки (18-35)')
