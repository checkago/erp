...
class Event(models.Model):
    ...
    invalids = models.IntegerField(default=0, verbose_name='Инвалиды (в том числе)')
...
class VisitReport(models.Model):
    ...
    qty_reg_15_35 = models.IntegerField(default=0, verbose_name='Новые (Молодежь 15-30)')
    qty_reg_other = models.IntegerField(default=0, verbose_name='Новые (Прочие 30+)')
    qty_reg_invalid = models.IntegerField(default=0, verbose_name='Новые (Инвалиды (в том числе))')
    ...
    qty_visited_invalids = models.IntegerField(default=0, verbose_name='Посещение (Инвалиды (в том числе))')
...
class BookReport(models.Model):
    ...
    qty_books_15_35 = models.IntegerField(default=0, verbose_name='Книговыдача (15-30)')
    qty_books_other = models.IntegerField(default=0, verbose_name='Книговыдача (Прочие 30+)')
    qty_books_invalid = models.IntegerField(default=0, verbose_name='Книговыдача (Инвалиды (в том числе))')
    ...
    qty_books_reference_invalid = models.IntegerField(default=0, verbose_name='Справки (Инвалиды (в том числе))')
