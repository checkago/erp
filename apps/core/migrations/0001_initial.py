    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='erp_user_groups', related_query_name='erp_user', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='erp_user_permissions', related_query_name='erp_user', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
