...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function firstWeekOffset(year, dow, doy) {
        // first-week day -- which january is always in the first week (4 for iso, 1 for others)
        var fwd = 7 + dow - doy;
    ...
    */
    ...
    function postProcess(s, date, standardDateProps, extendedSettings, context) {
        s = s.replace(LTR_RE, ''); // remove left-to-right control chars. do first. good for others regexes
        ...
        else if (extendedSettings.meridiem === 'lowercase') { // others meridiem transformers already converted to lowercase
    ...
    */
    ...
    // TODO: separate constraint/overlap/allow, because selection uses only that, not others props
    ...
    */
    ...
    var DateEnv = /** @class */ (function () {
        ...
        might as well use buildIsoString or some others util directly
        */
    ...
    var RAW_EN_LOCALE = __assign(__assign({}, MINIMAL_RAW_EN_LOCALE), { 
        // Includes things we don't want others locales to inherit,
        // things that derive from others translatable strings.
        buttonHints: {
            prev: 'Previous $0',
            next: 'Next $0',
    ...
    */
    ...
    - a minimum number of pixels or others criteria for a true drag to begin
        ...
        for (var subjectInstanceId in subjectInstances) {
            ...
            for (var otherInstanceId in otherInstances) {
                ...
                if (rangesIntersect(subjectRange, otherInstance.range)) {
                    ...
                    // consider the others event's overlap. only do this if the subject event is a "real" event
    ...
    */
    var RefMap = /** @class */ (function () {
        ...
        // NOTE: this method has become less valuable now that we are encouraged to map order by some others index
        ...
        MorePopover.prototype.queryHit = function (positionLeft, positionTop, elWidth, elHeight) {
            ...
            if (positionLeft >= 0 && positionLeft < elWidth &&
                ...
                return {
                    ...
                    layer: 1, // important when comparing with hits from others components
                };
            }
            return null;
        };
    ...
    */
    ...
    The moving element is a clone of some others element.
        ...
        segIsInvisible, isDragging, isResizing, isDateSelecting) {
            ...
            return (createElement(Fragment, null,
                ...
                segPlacements.map(function (segPlacement) {
                    ...
                    var isShort = Boolean(rect) && (rect.span.end - rect.span.start) < eventShortHeight; // look at others places for this problem
    ...
    */
    ...
    // rename this file to options.ts like others packages?
    var OPTION_REFINERS = {
